		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div id="content" class="sessionplan clearfix page">
			    ...
			    <div class="sessions_wrapper">
			        ...
			        <p class="session-disclaimer"> <a href="/wp-login.php">Login / Registrieren</a> - Um eine Session zu beanspruchen sprecht auf dem Event entweder jemand vom Orgateam an, oder schickt eine Mail an <a href="mailto:sessions@gamecampmunich.de">sessions@gamecampmunich.de</a>.</p>
